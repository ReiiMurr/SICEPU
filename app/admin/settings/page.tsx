                    ...
                    {[
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                i === 0 ? "bg-primary text-white shadow-xl shadow-primary/20" : "text-muted-foreground hover:bg-card hover:border-border border border-transparent"
                            )}
                        >
                            <item.icon size={20} className={cn("transition-transform", i === 0 ? "" : "group-hover:scale-110")} />
                            {item.name}
                        </button>
                    ))}
